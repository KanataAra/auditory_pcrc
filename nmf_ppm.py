...
def config():
    global id,ex,seed,display,Nx1,alpha_r1,alpha_b1,beta_b1,beta_r1,Nx2,alpha_r2,alpha_b2,beta_b2,beta_r2,beta,alpha1,tau1,alpha2,tau2,sigma1,sigma2,kx,kr,tauc,U0,lambda0,alpha_nmf,l1_ratio_nmf
    args = sys.argv
    for s in args:
        id      = arg2i(id,"id=",s)
        ex      = arg2a(ex, 'ex=', s)
...
def output():
    ...
    str="%d,%d,%d,%f,%f,%f,%f,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f\n" \
    % (id,seed,Nx1,alpha_r1,alpha_b1,beta_b1,beta_r1,Nx2,alpha_r2,alpha_b2,beta_b2,beta_r2,beta,alpha1,tau1,alpha2,tau2,sigma1,sigma2,kx,kr,tauc,U0,lambda0, alpha_nmf,l1_ratio_nmf, RMSE[0],RMSE[1],RMSE[2],NRMSE[0],NRMSE[1],NRMSE[2])
